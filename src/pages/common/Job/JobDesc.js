  ...
  return (
    ...
    >
      ...
      <Row className="mt-3 ms-4">
        ...
        <p><b>Experience Required:</b> 3+ years</p>
        <p><b>Pay(Performance based):</b> 10,00,000 - 20,00,000 CTC</p>
        <p><b>Apply Before:</b> 23/09/2023</p>
        <p className="mt-2"><b>Important pdf: </b><a href="/#" style={{color:primaryColor}}> document.pdf</a></p>
